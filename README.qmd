...
srn_grouped = srn_filtered |>
  ...
  mutate(Name = paste(road_classification_number, name, sep = " ")) |>
...
srn_grouped_linestring |>
  ...
  sf::st_cast("LINESTRING")
?st_cast
# nrow(srn_grouped) # 540
summary(srn_grouped_linestring$geom)
# summary(sf::st_length(srn_grouped))
#    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
#    1002    1751    3597   26440   18331  483252 

srn_grouped_split = srn_top_split = stplanr::line_segment(srn_grouped_linestring, segment_length = 1000)
